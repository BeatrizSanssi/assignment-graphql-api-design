...
//       doc: doc.toObject({ transform: null })
//     })
...
//   const filteredProperties = Array.from(
//     this.getFilteredSchemaPropertyMap().keys()
//   )
...
//       (property) => !filteredProperties.includes(property)
//     ).length > 0
//   )
// }
...
//   return Object.keys(obj).filter((property) =>
...
//   let result =
//     this.getIntersectionWithSchema(obj).length ===
//     this.getFilteredSchemaPropertyMap().size
